...
export function MobileNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around border-t-2 border-[#E5E5E5] dark:border-[#37464F] bg-white dark:bg-[#131F24] px-2 py-2.5 backdrop-blur-lg lg:hidden">
        ...
        return (
          <Link
            ...
            className={`flex flex-col items-center gap-0.5 rounded-xl px-2 py-1 transition-all ${
              isActive
                ? item.activeColor
                : "text-[#AFAFAF] dark:text-[#8495A0] hover:text-[#4B4B4B] dark:hover:text-white"
            }`}
          >
