...
const variantClasses: Record<Variant, string> = {
  ...
  white: "bg-white dark:bg-[#131F24] border-[#E5E5E5] dark:border-[#37464F] text-[#4B4B4B] dark:text-white hover:bg-[#F7F7F7] dark:hover:bg-[#202F36] focus-visible:ring-[#E5E5E5]/60",
