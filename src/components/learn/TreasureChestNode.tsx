...
export function TreasureChestNode({
  ...
  return (
    <div className="relative flex flex-col items-center py-6">
      ...
      <span className="mt-2 text-xs font-extrabold uppercase tracking-wide text-[#777777]">
      ...
      {showRewardModal && (
        ...
        >
          ...
          >
            <div className="relative mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-[#FFDFE0]/30">
            ...
            <div className="my-5 flex justify-center gap-4">
              <div className="rounded-2xl border-2 border-[#FFC800] bg-[#FFF9E6] px-4 py-2 text-center">
                <span className="text-xl font-extrabold text-[#FFC800]">+25</span>
                <p className="text-[10px] font-bold uppercase tracking-wider text-[#AFAFAF]">
                  Bonus XP
                </p>
              </div>
              <div className="rounded-2xl border-2 border-[#1CB0F6] bg-[#DDF4FF] px-4 py-2 text-center">
