    ...
    lessons: [
        ...
        exercises: [
          {
            ...
            promptText: "زمانی ئینگلیزی بە چ ئاراستەیەک دەخوێندرێتەوە؟",
            solutionData: {
              correct: "Left to Right ➡️ (لە چەپەوە بۆ ڕاست)",
              instruction: "Visual Anchor: English is read Left-to-Right (LTR)",
              icon: "➡️",
            },
            distractors: [
              "Right to Left ⬅️ (لە ڕاستەوە بۆ چەپ)",
              "Top to Bottom ⬇️ (لە سەرەوە بۆ خوارەوە)",
            ],
            order: 1,
          },
          {
            type: "word_bank",
            promptText: "پیتەکان لە چەپەوە بۆ ڕاست ڕیز بکە: S ➡️ A ➡️ T",
            solutionData: {
              tokens: ["S", "A", "T"],
              instruction: "Arrange letters left-to-right to form SAT",
              icon: "🔤",
            },
            distractors: ["P", "I"],
            order: 2,
          ...
          {
            type: "audio_match",
            promptText: "گوێ بگرە و وشەکە دیاری بکە: SAT",
            solutionData: {
              correct: "SAT",
              spokenText: "sat",
              instruction: "Listen and match the word SAT",
              icon: "🎧",
            },
            distractors: ["TAS", "AST"],
            order: 3,
      ...
      },
      {
        ...
        exercises: [
          {
            type: "audio_match",
            promptText: "گوێ لە دەنگی 'Hello' بگرە:",
            solutionData: {
              correct: "Hello",
              spokenText: "Hello",
              instruction: "Model Audio: Greeting",
              icon: "🔊",
            },
          ...
          {
            type: "audio_match",
            promptText: "مایکرۆفۆن دابگرە و بڵێ: 'Hello'",
            solutionData: {
              correct: "Hello",
              spokenText: "Hello",
              isSpeaking: true,
              instruction: "Speak Rehearsal: Hello",
              icon: "🎤",
            },
            distractors: [],
            order: 2,
          ...
          {
            type: "multiple_choice",
            promptText: "دەنگی /s/ لە کام پیتەوە دێت؟",
            solutionData: {
              correct: "S",
              spokenText: "s",
              instruction: "Crisp unvoiced /s/",
              icon: "🐍",
            },
            distractors: ["M", "B"],
            order: 3,
      ...
      },
      {
        ...
        exercises: [
          {
            type: "multiple_choice",
            promptText: "لە هەر وانەیەک چەند دڵت هەیە بۆ هەڵەکان؟",
            solutionData: {
              correct: "5 Hearts ❤️ (٥ دڵ)",
              instruction: "Hearts refill to 5 at every lesson start",
              icon: "❤️",
            },
            distractors: ["1 Heart ❤️", "10 Hearts ❤️"],
            order: 1,
          },
          {
            type: "multiple_choice",
            promptText: "کۆتایی هەر بەشێک پشکنینی چی هەیە؟",
            solutionData: {
              correct: "Checkpoint 🏁 (خاڵی پشکنین)",
              instruction: "Checkpoints unlock the next section",
              icon: "🏁",
            },
            distractors: ["Skip forever", "Game over"],
            order: 2,
          },
          {
            type: "multiple_choice",
            promptText: "تەواوکردنی هەر وانەیەک چیت پێ دەبەخشێت؟",
            solutionData: {
              correct: "XP & Streak ⚡ (خاڵ و زنجیرە)",
              instruction: "Earn XP and build your daily learning streak!",
              icon: "⚡",
            },
            distractors: ["Nothing", "Reset"],
            order: 3,
          },
        ],
      },
      {
        ...
        exercises: [
          {
            type: "multiple_choice",
            promptText: "یەکەم ٦ پیتی ئینگلیزی چین کە فێریان دەبین؟",
            solutionData: {
              correct: "S, A, T, P, I, N",
              instruction: "Section 1: The Core Six Letters",
              icon: "🎯",
            },
            distractors: ["X, Y, Z, Q, W", "K, L, M, N, O"],
            order: 1,
          },
          {
            type: "multiple_choice",
            promptText: "ئامادەیت بۆ دەستپێکردن؟",
            solutionData: {
              correct: "I am ready! 🚀 (من ئامادەم)",
              instruction: "Launch into Section 1!",
              icon: "🚀",
            },
            distractors: ["No", "Later"],
            order: 2,
          },
        ],
      },
